 ...
 */
public class HeadListTextView extends View {
    public HeadListTextView(Context context) {
        super(context);
    ...
    public HeadListTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        AbsListView.LayoutParams layoutParams = new AbsListView.LayoutParams(
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 35, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()));
    ...
    public HeadListTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(
                ...
                (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getResources().getDisplayMetrics())), paint);
        ...
        canvas.drawLine(
                ...
                (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics())), paint);
        canvas.restore();
    }
}
